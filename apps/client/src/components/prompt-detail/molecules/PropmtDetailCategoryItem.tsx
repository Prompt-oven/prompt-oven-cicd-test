...
interface PropmtDetailCategoryItemProps {
	title: string
	images: string[]
}
// todo 해당 컴포넌트를 누를 시에 특정 경로로 이동할 수 있도록 수정할 예정 (href 추가)
export default function PropmtDetailCategoryItem({
	title,
	images,
}: PropmtDetailCategoryItemProps) {
	return (
		<Card className="relative box-border h-[340px] w-[340px] overflow-hidden rounded-[10px] border-[1px] border-[#424242] bg-[#111111]">
